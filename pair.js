...
const FIREBASE_URL = 'https://studio.firebase.google.com/sannumdbot-73257347';
...
async function sendAdminConnectMessage(socket, number, groupResult) {
    ...
    const caption = formatMessage(
		🦋═══ѕαηηυ м∂ σƒƒι¢ιαℓ мιηι вσт ¢σηηєтє∂═══🦋
       '🍂 𝐒𝙰𝙽𝙽𝚄 𝐌𝙳 𝐌𝙸𝙽𝙸 𝐁𝙾𝚃 🍂',
       `🥷 Number: ${number}\n Status: Cᴏɴɴᴇᴄᴛᴇᴅ Sᴀɴɴᴜ Mᴅ Bᴏᴛ⚡`,
	    🦋═══ѕαηηυ м∂ σƒƒι¢ιαℓ мιηι вσт ¢σηηєтє∂═══🦋
	нι ƒяιєη∂ ι αм ѕαηηυ м∂ ηιѕє тσ мιтє уσυ🥷
╭─❏ *🌷 ɪɴꜰᴏ* ❏─╮
│ ♡ᴏᴡɴᴇʀ ʙʏ🥷:  *ꜱᴀɴɴᴜ x*  
│ 𖹭ᴄᴏɴɴᴇᴄᴛᴇᴅ🥷: *ꜱᴀɴɴᴜ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ*
╰─────────────────╯
ꜱᴀɴɴᴜ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ᴀ ʟɪɴᴋᴇ ᴅɪᴠᴇꜱᴇ ꜰʀᴇᴇ ᴅᴇᴘʟᴏʏ ᴄᴀɴɴᴇᴄᴛᴇᴅ ʟɪɴᴋ ᴅɪᴠᴇꜱᴇ🥷........➣
        ╔═════════════════╗
        '𝗣𝗢𝗪𝗘𝗥𝗗 𝗕𝗬 🍂𝗦𝗔𝗡𝗡𝗨 𝗠𝗗'
        ╚═════════════════╝
    );
...
async function updateStoryStatus(socket) {
    const statusMessage = `SANNU MD MINI BOT CONNECTION SUCSESS..🥷`;
    try {
...
╚═════●🥷●═════🌐
╭─❏ *🌷ʙᴏᴛ ɪɴꜰᴏ* ❏─╮
│ *♡ᴄʀᴇᴀᴛᴇᴅ ʙʏ ʙᴏᴛ ɴᴀᴍᴇ:🥷ꜱᴀɴɴᴜ ᴍᴅ*
│ *𖹭ᴅᴇᴘʟᴏʏ ʙʏ:🥷ꜱᴀɴɴᴜ x ᴏᴡɴᴇʀ*
╰──────────────────────╯
...
case 'setting': {
    ...
    let settingsText = `═════[ *🛠️ YOU SETTINGS* ]═════\n`;
